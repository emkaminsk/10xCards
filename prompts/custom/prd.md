...
### Wskazania co do technicznych komponentów:
- frontent w Typescript i React
- backend w Python z FastAPI
- baza danych Postresql
- produkt budowany za pomocą docker compose z kontenerów m. in. postresql
- testy jednostkowe w Jest i PyTest
